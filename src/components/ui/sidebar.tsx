  ...
  const getMenuItems = () => {
    ...
    switch (userRole) {
      ...
      case 'contractor':
        return [
          ...baseItems,
          { name: 'Active Projects', href: '/contractor/projects', icon: FileText },
          { name: 'My Proposals', href: '/contractor/proposals', icon: Briefcase },
      ...
      case 'admin':
        return [
          ...
          { name: 'Financial Reports', href: '/admin/financials', icon: DollarSign },
        ]
          ...
          {!isCollapsed && (
            <div className="p-4 border-t border-gray-200 flex-shrink-0">
              <div className="text-xs text-gray-500 text-center">
                <p>© 2024 CoreXLab</p>
                <p className="mt-1 capitalize">{userRole || 'User'} Dashboard</p>
              </div>
            </div>
          )}
        </div>
