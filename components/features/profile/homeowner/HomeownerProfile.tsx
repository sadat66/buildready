  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Homeowner Profile</h1>
          <p className="text-gray-600">Manage your homeowner account information</p>
        </div>
        <Link href="/homeowner/dashboard">
          <Button variant="outline" size="sm">
            <ArrowLeft className="h-4 w-4 mr-2" />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your homeowner account details</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-700">Account Type</Label>
              <p className="text-sm text-gray-900 capitalize">Homeowner</p>
            </div>
            <div className="space-y-2">
