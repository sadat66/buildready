...
export default function ProjectDetailPage() {
  ...
  if (!user || userRole !== USER_ROLES.CONTRACTOR) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-slate-50">
        <div className="text-lg text-slate-600 font-medium">
          Access denied. Only contractors can view project details.
        </div>
      </div>
    );
  }
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-4 bg-slate-50 rounded-xl">
                      ...
                      <Badge
                        variant={
                          project.permit_required ? "default" : "secondary"
                        }
                        className={
                    ...
                    <div className="p-4 bg-slate-50 rounded-xl">
                      ...
                      <Badge
                        variant={
                          project.is_verified_project ? "default" : "secondary"
                        }
                        className={
                ...
                <CardContent>
                  <div className="p-4 bg-slate-50 rounded-xl">
                    ...
                    <p className="text-slate-900 font-semibold">
                      {project.homeowner
                        ? (() => {
                            const homeowner = project.homeowner as {
                              first_name?: string;
                              last_name?: string;
                              full_name?: string;
                            };
